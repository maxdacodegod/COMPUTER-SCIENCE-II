...
Date: 2/22/24
Effort: 10 Hours Collectively
Purpose: The purpose of this program is to create an object that holds flags.
This dynamic set of flags are set as 0 or 1, 0 being not set and 1 being set.
You can set/unset any position for the flag, if you intialize 10 flags and want to
access the 200th flag, the structure resizes in order to meet the requirement.

Interface proposal: ?

I belive a function that would be useful to have is a resize function that you can call
to resize if you are experiencing an out-of-bounds error.
***********************************************************/
